...
<div class="container">
    ...
    <div id="main">
        ...
        <% try {
            connection = DriverManager.getConnection("jdbc:sqlite:C:\\Users\\Alejandro\\IdeaProjects\\ShareCare\\project.db");
            ...
            if (resultSet.next()) {
                ...
                switch (skill) {
                    case 1:
                        skillString = "Carpintería";
                        break;
                    case 2:
                        skillString = "Electricidad";
                        break;
                    case 3:
                        skillString = "Fontanería";
                        break;
                    case 4:
                        skillString = "Jardinería";
                        break;
                }
                ...
                if (contributorResultSet.next()) {
                    ...
                    switch (contributorSkillID) {
                        case 1:
                            contributorSkill = "Carpintería";
                            break;
                        case 2:
                            contributorSkill = "Electricidad";
                            break;
                        case 3:
                            contributorSkill = "Fontanería";
                            break;
                        case 4:
                            contributorSkill = "Jardinería";
                            break;
                    }
                }
                out.println("<br>");
                ...
                // Obtener el teléfono y el correo electrónico del contribuidor
                String contributorPhone = "";
                String contributorEmail = "";
                String contributorDetailsSql = "SELECT phone, email FROM User WHERE userName = ?";
                PreparedStatement contributorDetailsStatement = connection.prepareStatement(contributorDetailsSql);
                contributorDetailsStatement.setString(1, contributor);
                ResultSet contributorDetailsResultSet = contributorDetailsStatement.executeQuery();
                if (contributorDetailsResultSet.next()) {
                    contributorPhone = contributorDetailsResultSet.getString("phone");
                    contributorEmail = contributorDetailsResultSet.getString("email");
                }

                // Mostrar el teléfono y el correo electrónico del contribuidor
                out.println("<p><strong>Teléfono del contribuidor:</strong> " + contributorPhone + "</p>");
                out.println("<p><strong>Correo electrónico del contribuidor:</strong> " + contributorEmail + "</p>");
                ...
                contributorDetailsResultSet.close();
                contributorDetailsStatement.close();
